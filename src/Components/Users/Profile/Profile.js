...
import { fetchProfileAction } from "../../redux/reducers/profileSlice";
...
export default function Profile() {
  ...
  const { profile ,profilePhoto,profileUpdated,
    profileFollowed ,
    loading, appErr, serverErr } = userProfile;
  const posts = profile?.posts

  useEffect(() => {
    dispatch(fetchProfileAction(id))
  }, [id, dispatch , profilePhoto , profileUpdated , profileFollowed ]);
  ...
  return (
    <>
      <div className="h-screen flex overflow-hidden bg-white">
        ...
        {loading ? <LoadingComponent/> : serverErr || appErr ?
        <h2 className="text-yellow-400 text-2xl">{appErr} {serverErr}</h2> : 
                    ...
                    <div className="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
                      ...
                      <div className="mt-6 sm:flex-1 sm:min-w-0 sm:flex sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                        <div className=" flex flex-col 2xl:block mt-10 min-w-0 flex-1">
                          ...
                          <p className="m-3 text-md">
                            Date Joined:
                            <DateFormatter date={profile?.createdAt} />{" "}
                          </p>
                          <p className="text-green-400 mt-2 mb-2 text-sm">
