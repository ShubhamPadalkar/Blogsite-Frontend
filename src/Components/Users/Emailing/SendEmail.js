...
import { sendMessageAction } from "../../redux/reducers/emailSlice";
...
const SendEmail = () => {
  ...
  const profileMail =  params?.get('email')
  ...
  const formik = useFormik({
    ...
    onSubmit: values => {
      ...
      //dispath the action
      dispatch(sendMessageAction(mailContent))
    },
    validationSchema: formSchema,
  });

  const mailSent = useSelector(state => state?.email?.isSent)
