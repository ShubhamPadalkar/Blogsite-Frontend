...
import { registerUserAction } from "../../redux/reducers/userSlice";
              ...
              <div className="px-6 lg:px-20 py-12 lg:py-24 bg-gray-600 rounded-lg">
                <form onSubmit={formik.handleSubmit}>
                  ...
                  {/* Check loading */}
                  {
                    ...
                    <button
                    disabled
                    className="py-4 w-full bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-full transition duration-200"
                  >
                    Loading Please Wait..
                  </button>
                  :
